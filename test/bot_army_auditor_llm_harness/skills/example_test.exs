defmodule BotArmyAuditorLlmHarness.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorLlmHarness.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_llm_harness.command.example" in triggers
    end
  end
