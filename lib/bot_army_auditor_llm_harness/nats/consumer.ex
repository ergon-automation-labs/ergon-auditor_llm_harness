defmodule BotArmyAuditorLlmHarness.NATS.Consumer do
  @moduledoc """
  NATS message consumer for auditor_llm_harness.
  ...
  def handle_continue(:connect, state) do
    case GenServer.call(BotArmyLibraryRuntime.NATS.Connection, :get_connection, 5000) do
      {:ok, conn} ->
        ...
        BotArmyLibraryRuntime.Registry.register("auditor_llm_harness", @subjects, @version)
