defmodule BotArmyAuditorLlmHarness.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyAuditorLlmHarness.HTTPClient.Req)
...
defmodule BotArmyAuditorLlmHarness.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyAuditorLlmHarness.HTTPClient
