defmodule BotArmyAuditorLlmHarness.Skills.Example do
  @moduledoc """
  Example skill for LLM Harness Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_llm_harness.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_llm_harness.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_llm_harness/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_llm_harness.command.example"
    ]
  end
