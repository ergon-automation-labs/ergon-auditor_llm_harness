defmodule BotArmyAuditorLlmHarness.PulsePublisher do
  @moduledoc """
  Periodic health publisher for LLM Harness Bot.
  ...
  2. **`bot.auditor_llm_harness.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_llm_harness"
  @envelope_source "bot_army_auditor_llm_harness"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting LLM Harness Bot pulse publisher")
